...
#         print('v_tp',v_tp)
  ...
  #           print('xiangjiao.area',xiangjiao.area)
    ...
    def zuijiejinliangdiandemianji(self):
        ...
        if len(xzuobiao)==(allstep+1):
            ...
            xiaoyutheone_x = fuckxiao_x[0]
            
            xiaoyutheone_z = fuckxiao_z[0]   
            
            
            area_portion = self.shinengjisuan_shape(dayutheone_x,dayutheone_z,xiaoyutheone_x,xiaoyutheone_z)
